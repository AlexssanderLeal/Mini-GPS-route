...
(function(global, $) {
  ...
  $.fn[pluginName].defaults = {
    ...
    // 'Previous' text
    // prevText: '&laquo;',
    prevText: '<i class="fa fa-lg fa-angle-double-left" aria-hidden="true" style="font-weight: bold;"></i>',

    // 'Next' text
    // nextText: '&raquo;',
    nextText: '<i class="fa fa-lg fa-angle-double-right" aria-hidden="true" style="font-weight: bold;"></i>',
